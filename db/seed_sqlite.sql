...
INSERT OR REPLACE INTO users (user_id, employee_no, username, full_name, email, role, dept_id, password_hash, approval_pin_hash, theme_preference) VALUES
  ('00000000-0000-0000-0001-000000000001','EMP001','admin','System Administrator','admin@masapp.local','admin','00000000-0000-0000-0000-000000000001','$2a$10$kCWRye5Sa.VdECJCmMu9nuPGOdnpJy.xBDpoJzR9ooMCHGNMGMXEe','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','dark'),
  ('00000000-0000-0000-0001-000000000002','EMP002','somchai','สมชาย มีทักษะ','somchai@masapp.local','technician','00000000-0000-0000-0000-000000000001','$2a$10$VIYSP4OrO50rq94hTRYa1uQGVnnqZYYfwL/72DAnqrai6cHJEWBBW','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','dark'),
  ('00000000-0000-0000-0001-000000000003','EMP003','siriporn','สิริพร วิศวกร','siriporn@masapp.local','engineer','00000000-0000-0000-0000-000000000001','$2a$10$VIYSP4OrO50rq94hTRYa1uQGVnnqZYYfwL/72DAnqrai6cHJEWBBW','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','light'),
  ('00000000-0000-0000-0001-000000000004','EMP004','prasit','ประสิทธิ์ ช่างไฟ','prasit@masapp.local','technician','00000000-0000-0000-0000-000000000001','$2a$10$VIYSP4OrO50rq94hTRYa1uQGVnnqZYYfwL/72DAnqrai6cHJEWBBW','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','dark'),
  ...
  ('00000000-0000-0000-0001-000000000006','EMP006','chaiyapol','ชัยพล จป.','chaiyapol@masapp.local','safety','00000000-0000-0000-0000-000000000004','$2a$10$VIYSP4OrO50rq94hTRYa1uQGVnnqZYYfwL/72DAnqrai6cHJEWBBW','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','dark'),
  ('00000000-0000-0000-0001-000000000007','EMP007','wichai','วิชัย ผู้บริหาร','wichai@masapp.local','executive','00000000-0000-0000-0000-000000000001','$2a$10$VIYSP4OrO50rq94hTRYa1uQGVnnqZYYfwL/72DAnqrai6cHJEWBBW','$2a$10$i8DZMOtN3QgsxV.PvM7FduSgZ1i.bN330iGqNclrkqrMkuBc0XjG.','light');
