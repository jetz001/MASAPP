...
import '../../features/notifications/widgets/notification_popover.dart';
...
const _navItems = [
  ...
  _NavItem(
    label: 'เนเธเธเนเธกเนเธเธ PM/AM',
    icon: HugeIcons.strokeRoundedBookOpen01,
    iconSelected: HugeIcons.strokeRoundedBookOpen01,
    route: '/pm-am-plans',
  ),
  _NavItem(
    label: 'เธเธณเธซเธเธเธเธฒเธฃ PM/AM',
    icon: HugeIcons.strokeRoundedCalendar03,
    iconSelected: HugeIcons.strokeRoundedCalendar03,
    route: '/pm-am',
  ),
  _NavItem(
    label: 'เนเธเนเธเนเธเธเนเธญเธก',
    icon: HugeIcons.strokeRoundedTask01,
    iconSelected: HugeIcons.strokeRoundedTask01,
    route: '/work-orders',
  ),
  _NavItem(
    label: 'เธเธฐเนเธเธตเธขเธเธเธนเนเธฃเธฑเธเนเธซเธกเธฒ',
  ...
  _NavItem(
    label: 'เนเธเธญเธเธธเธเธฒเธเธเธณเธเธฒเธ',
  ...
  _NavItem(
    label: 'เธเธฑเธเธเธฒเธฃเธเธนเนเนเธเน',
  ...
  _NavItem(
    label: 'เธเธฒเธฃเธเธฑเนเธเธเนเธฒ',
              ...
              child: IntrinsicHeight(
                child: Column(
                  children: [
                    ...
                    _NavTile(
                      item: const _NavItem(
                        label: 'เธญเธญเธเธเธฒเธเธฃเธฐเธเธ',
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            Text(
              'เธฃเธฐเธเธเธเธฃเธดเธซเธฒเธฃเธเธฑเธเธเธฒเธฃเธเนเธญเธกเธเธณเธฃเธธเธ',
...
class _ThemeToggleButton extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Tooltip(
      message: isDark ? 'เธชเธฅเธฑเธเนเธเนเธ Light Mode' : 'เธชเธฅเธฑเธเนเธเนเธ Dark Mode',
      child: Builder(
        builder: (ctx) {
