              ...
              data: (parts) {
                if (parts.isEmpty) {
                  return const Padding(
                    ...
                    child: Text('�ѧ����ա���ԡ������', style: TextStyle(color: Colors.grey, fontStyle: FontStyle.italic)),
                  );
                }
                return Column(
                    ...
                    return Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          Text('${p.quantity} ���', style: const TextStyle(fontWeight: FontWeight.w500)),
                            ...
                            onTap: () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (c) => AlertDialog(
                                  title: const Text('�׹�ѹ��ä׹������?'),
                                  content: Text('�س��ͧ��ä׹ ${p.partName} �ӹǹ ${p.quantity} ��� ��Ѻ��Ҥ�ѧ���������?'),
                                  actions: [
                                    TextButton(onPressed: () => Navigator.pop(c, false), child: const Text('¡��ԡ')),
                                    TextButton(
                                      onPressed: () => Navigator.pop(c, true), 
                                      child: const Text('�׹�ѹ�׹������', style: TextStyle(color: Colors.red)),
                                    ),
                                  ],
                                ),
                              );
                              if (confirm == true) {
                                ...
                                if (success) {
                                  ...
                                  if (context.mounted) {
                                    ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('�Դ��ͼԴ��Ҵ㹡�ä׹������')));
                                  }
                                }
                              }
                            },
