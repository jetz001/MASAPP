...
new_ui = """                      // --- NEW FIELDS ---
                      ...
                      TextFormField(
                        ...
                        style: AppTextStyles.bodyMedium,
                        obscureText: true,
                        decoration: const InputDecoration(hintText: 'ปล่อยว่างหากต้องการใช้ Admin@1234', prefixIcon: Icon(Icons.lock)),
                      ),
                      const SizedBox(height: 20),
                      ...
                      Text('ที่อยู่ไฟล์ฐานข้อมูล (.db)', style: AppTextStyles.labelLarge.copyWith(color: AppColors.textSecondary)),
